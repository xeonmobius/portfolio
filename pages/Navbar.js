          ...
          <ul className="raleway flex space-x-8">
            <li>
              <Link
                ...
                className="py-2 px-4"
              >
                <p className="hover:cursor-pointer hover:underline text-black">Resume</p>
              </Link>
            </li>
            <li>
              <Link href="/pastWork" className="py-2 px-4">
                <p className="hover:cursor-pointer hover:underline block text-black">Past Work</p>
              </Link>
            </li>
            <li>
              <Link href="/blog" className="py-2 px-4">
              <p className="hover:cursor-pointer hover:underline text-black">Blog</p>
              </Link>
            </li>
            <li>
              <Link href="/contactMe" className="py-2 px-4">
                <p className="hover:cursor-pointer hover:underline block text-black">Contact me</p>
              </Link>
            </li>
          </ul>
        </div>
